					...
					<div className="grid grid-cols-1 gap-4 px-4 py-6 md:py-8 md:grid-cols-4">
						<div>
							<div className="flex items-center align-middle gap-2 mb-3">
								<Image
									...
									height={35}
								/>
								<h1 className="text-emerald-600 font-extrabold text-xl dark:text-white">
									aid
							...
							<p className="text-white leading-7 dark:text-gray-400 font-medium w-[90%]">
								...
								your cause and ensures readability.
							</p>
						</div>
						<div>
						...
						<div>
							...
							<form>
								...
								<button
									type="submit"
									className="bg-emerald-600 text-white px-4 py-2 rounded hover:bg-emerald-600 transition-colors duration-300"
								>
									Subscribe
								</button>
							</form>

    ...
    return (
        <div  ref={ref}>
            <div>
                ...
                <div>
                <ReactToPrint trigger={() => <button className="bg-green-300 rounded-xl py-3 px-5 ml-[440px] md:ml-[300px]"><FaDownload></FaDownload></button>} content={() => ref.current}></ReactToPrint>
                </div>

		...
		<div className="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-16">
			<div>
				...
				<p className="font-semibold mt-2">
					Forced to give birth while fleeing conflict, new mothers and
					their newborns are urgently counting on our help.
				</p>
				...
				<p className="font-semibold mt-3">
					Please make an act of kindness for a mother and her newborn
					and send a Mama Kit now.
				</p>
			</div>
			<div className="w-96">
				<Tabs>

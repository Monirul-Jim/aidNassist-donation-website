...
const Feeddelete = ({ feed, handleDeleteFeedback }) => {
	...
	return (
		<div className='mx-auto'>
			<div key={_id} className="lg:w-[550px] lg:h-[300px] w-96 p-6 bg-white  border-green-400 rounded-lg shadow dark:bg-gray-800  border-4 gap-5">
				...
				<button className="bg-green-400 p-3 rounded-xl text-white" onClick={() => handleDeleteFeedback(_id)}>Delete FeedBack</button>
			</div>
		</div>
	);
};

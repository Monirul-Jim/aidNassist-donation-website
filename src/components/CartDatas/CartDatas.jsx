...
const CartDatas = () => {
	...
	const handlePayment = async () => {
		...
		try {
			const { data } = await axios.post(
				"/api/storeSslPayments/create-payment",
				{
					price: money,
					email: user?.email,
				}
	...
	return (
		<div className="">
			<div className="flex justify-around items-center mb-20 mx-5 md:mx-10">
				<h2 className="text-center font-bold rounded-lg bg-green-300 dark:bg-black px-5 py-2">
				...
				<button
					...
					className="rounded-lg bg-green-300 dark:bg-black px-5 py-2 font-bold"
				>
					Checkout
				</button>
			</div>

		...
		<section>
			...
			<div className="flex flex-col pt-8 pb-16 lg:flex-row gap-5 justify-center items-center mt-10">
				<div class="max-w-xs relative">
					<a href="#" class="block">
						<Image
							class="rounded-t-lg " width={250} height={20} 
							src="/Volunteer-Image-1.jpg"
							alt="img4"
						/>
					</a>
					<div class="absolute bottom-[-7%] left-0 w-[80%] bg-white border border-gray-200 rounded-b-lg shadow dark:bg-gray-800 dark:border-gray-700 p-4 flex items-center align-middle mx-7 text-center">
						<h2 class="text-xl font-extrabold mb-2 mx-auto text-emerald-600">
							baron Mordo <br />

        ...
        <div>
            ...
            <aside id="logo-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
                <div className="h-full px-3 py-4 overflow-y-auto bg-green-200 dark:bg-gray-800">
                    ...
                    <div className='mb-5'>
                        <div className='flex justify-center mt-5 mb-2'><Image src='https://img.freepik.com/free-icon/user_318-159711.jpg' alt='No one Here' width={100} height={100}></Image></div>
                        <div>
                            <h2 className='text-center text-xl'>Profile Name</h2>
                            <p className='text-center text-sm italic'>email@info.com</p>
                        </div>
                    </div>

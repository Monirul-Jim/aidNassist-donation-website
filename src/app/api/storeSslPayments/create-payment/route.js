...
export async function POST(request) {
    ...
    try {
        const data = {
            ...
            success_url: "https://test-another-next-proj.vercel.app/api/storeSslPayments/payment-callback",
            fail_url: "https://test-another-next-proj.vercel.app/api/storeSslPayments/payment-callback",
            cancel_url: "https://test-another-next-proj.vercel.app/api/storeSslPayments/payment-callback",
            emi_option: 0,
            customer_name: "name",
            cus_email: email,

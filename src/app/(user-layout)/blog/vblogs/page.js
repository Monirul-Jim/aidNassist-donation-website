...
const VBLOGS = () => {
    ...
    const getallusers = async () => {
        let data = await fetch("/api/vblogs");
    ...
    return (
        <div>
            <h1 className="text-center text-3xl text-gray-500 mb-2">Volunteers blogs</h1>
                        ...
                        <div className="lg:grid lg:grid-cols-4 lg:gap-5">
                            {
                                userVols.map((blog) => (
                                    ...
                                    <div key={blog._id} className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                                        <a href="#">
                                            <Image className="rounded-t-lg" width={300} height={300} src={blog.imageUrl} alt="Pic Nye" />
                                        </a>
                                        <div className="p-5">
                                            ...
                                            <Link href={`/blog/vblogs/${blog._id}`} className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                                Read Blog
